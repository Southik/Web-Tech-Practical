...
<head>
    ...
    <title>Men's Clothing List</title>
...
<body>
    ...
    <h1 class="page-title">ALL THE CLOTHES FOR MEN</h1>
    ...
    <div class="category" id="shirts">
        ...
        <div class="product-grid">
            ...
            <div class="product-card">
                <img src="../img/menshirt2.png" alt="Casual Blue Shirt" class="product-image" />
                <div class="product-name">Casual Blue Shirt</div>
                <div class="product-description">
