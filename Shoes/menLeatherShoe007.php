...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Classic Black Leather Shoe</title>
    ...
    <section class="product-detail">
      <div class="product-layout full-width-layout">
        <div class="product-image-container full-image">
          <img
            src="../img/leather shoe.png"
            alt="Classic Black Leather Shoe"
            class="product-image"
          />
        </div>

        <div class="product-info">
          <h1 class="page-title">Classic Black Leather Shoe</h1>
          <p class="product-subtitle">
            Handcrafted elegance made for everyday comfort and timeless style.
          </p>
