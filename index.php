...
<body>
   ...
   <section class="hero">
	    <div class="slider-wrapper"> 
			<div class= "slider">
				<img id="img1" src="img/heroimage.jpg" alt="Store Image">
				<img id="img2" src="img/medium-shot-happy-woman-carrying-shopping-bags.jpg" alt="Store Image">
				<img id="img3" src="img/stylish-casual-african-american.jpg" alt="Store Image">
				<img id="img4" src="img/shopping-packet-sale-sign.jpg" alt="Store Image">
				<img id="img5" src="img/Tshirts.jpg" alt="Store Image">
